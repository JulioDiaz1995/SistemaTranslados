...
use PhpOffice\PhpWord\Shared\text;
 ...
 * Text element
 */
class texto extends AbstractElement
{
    /**
     * Text content
     *
 ...
 function __construct($text = null, $fontStyle = null, $paragraphStyle = null)
    {
        $this->setText($text);
     ...
     */
    function setFontStyle($style = null, $paragraphStyle = null)
    {
     ...
     */
    function setParagraphStyle($style = null)
    {
        if (is_array($style)) {
