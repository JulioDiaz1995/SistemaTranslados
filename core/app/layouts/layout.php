...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Plasencia | Escritorio</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <link rel="icon" href="plasencia.ico" class="img-avatar img-circle">
...
<script type="text/javascript" src="plugins/jsqrcode/webqr.js"></script>
  ...
  <body style="background:  url(fondo_plasencia.jpg) center center no-repeat;    background-size:100% 100%;" class="<?php if(isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])):?>  skin-blue-light sidebar-mini <?php else:?>login-page<?php endif; ?>" >
    <div class="wrapper">
      <!-- Main Header -->
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><img class="img-avatar " src="rr.png" alt="" style="width: 50px; height: 60px;"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>PLASENCIA</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./?view=remision"><i class='fa fa-send'></i> <span>Traslados</span></a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="./?view=clients">Empleados</a></li>
                <li><a href="./?view=providers">Encargados</a></li>
              </ul>
            </li>
...
<div class="login-logo">
        <a href="./"><b style="color: #fff;">Plasencia Inventario</b></a>
        <img class="img-avatar img-circle" src="plasencia-logo.jpg" alt="" style="width: 100px; height: 100px;">
      </div><!-- /.login-logo -->
