...
<thead>
	...
	<th>Producto</th>
	<th style="width:30px;">Estado Inicial</th>
...
<div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Empleados</label>
    <div class="col-lg-10">
    <?php 
...
<div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" name="discount" class="form-control" required value="" id="discount" placeholder="Estado" maxlength="25">
    </div>
  </div>
 <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Tipo de Salida</label>
    <div class="col-lg-10">
      <input type="text" name="money" required class="form-control" id="money" placeholder="Tipo de Salida" maxlength="25">
    </div>
  </div>
      <input type="hidden" name="total" value="<?php echo $total; ?>" class="form-control" placeholder="Total" maxlength="5">
...
<div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <div class="checkbox">
        ...
        <button class="btn btn-lg btn-primary"><i class="glyphicon glyphicon"></i><i class="glyphicon glyphicon"></i> Finalizar Traslado</button>
        </label>
      </div>
    </div>
  </div>
...
<script>
	$("#processsell").submit(function(e){
		...
		if(money<(<?php echo $total;?>-discount)){
			...
			go = confirm("Confirme:"+(money-(<?php echo $total;?>-discount ) ) );
			if(go){}
