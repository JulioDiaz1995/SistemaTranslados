...
<?php foreach($operations as $operation):?>
	<tr>
		...
		<td>$ <?php echo $operation->discount; ?></td>
		<td>$ <?php echo $operation->total-$operation->discount; ?></td>
...
<h1>Total de Traslado:  <?php echo $supertotal; ?></h1>
