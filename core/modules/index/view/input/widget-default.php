...
<br><form class="form-horizontal" method="post" action="index.php?view=processinput" role="form">
   <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="number" value="<?php echo $product->unit; ?>" readonly="readonly" class="form-control" id="inputEmail1" placeholder="Cantidad de productos" maxlength="5">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Cantidad</label>
    <div class="col-lg-10">
      <input type="float" required name="q" class="form-control" id="inputEmail1" placeholder="Cantidad de productos" maxlength="5">
    </div>
  </div>
