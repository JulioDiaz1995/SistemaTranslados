...
<thead>
	...
	<th>Producto</th>
	<th style="width:30px;">Estado Salida</th>
...
<div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" name="discount" class="form-control" required value="0" id="discount" placeholder="Estado" maxlength="25">
    </div>
  </div>
 <div class="form-group">
