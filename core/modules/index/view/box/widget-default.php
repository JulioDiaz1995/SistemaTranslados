...
<a href="./index.php?view=processbox" class="btn btn-primary ">Procesar Traslados <i class="fa fa-arrow-right"></i></a>
</div>
...
?>
	<div class="jumbotron">
		<h2>No hay traslados</h2>
		<p>No se ha realizado ninguna traslados.</p>
	</div>
