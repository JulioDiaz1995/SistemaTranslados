...
$section1->addText("RESUMEN DE TRASLADOS",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$table1->addRow();
$table1->addCell(3000)->addText("Encargado");
...
$table2->addCell(1000)->addText("Estado Inicial");
...
$table2->addCell()->addText($product->price_out);
$table2->addCell()->addText($operation->q*$product->price_out);
